;This script can be used in any FP game it only turns around your camera really fast too look buggy, but it is easy to control as it only does 2 half turns so you can keep seeing the front and the back.
;To use this script you must have interception installed and change the mouseid values.
