;This script is used in the game Overwatch 2 with the hero "Soldier 76". It aims automaticly to the enemies thanks to the color of their hpbars (red). THIS SCRIPT IS STILL BEING DEVELOPED
...
global LBDown := false
global WeirdRed := "0x2319CF|0x231AD0|0x2418CF|0x4C34D2|0x4B31D2|0x1E0ECE|0x1F0FCE|0x5A4DD7|0x3020CB|0x2E28CF|0x4A17CA"
...
Change(state){
Run, C:\Users\DEEPGAMING\Downloads\AHK\Scripts\Ov\S76\Soldado.ahk
ExitApp
}
...
moveEnemy(){
    ...
    if (Ultimating=false){
        while(LBDown = true){
        PixelSearch, OutputVarX, OutputVarY, 700, 500, 1320, 580, WeirdRed, 3, Fast
        if( OutputVarX != null){
